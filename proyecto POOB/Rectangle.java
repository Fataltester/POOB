...
public class Rectangle{
    ...
    int yPositionGiven,String colorGiven){
        height = heightGiven;
        width = widthGiven;
        xPosition = xPositionGiven;
        yPosition = yPositionGiven;
        color = colorGiven;
        isVisible = false;
    }    
    ...
    public void changeSize(int newHeight, int newWidth) {
        ...
        if (newWidth<=0){
            ...
            System.out.print("no se puede crear el rectangulo con la anchura dada");
    ...
    /**
     * Move the rectangle to an specific position
